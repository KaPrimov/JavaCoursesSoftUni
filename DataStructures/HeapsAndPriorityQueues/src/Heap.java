public class Heap {
    ...
    private static <E extends Comparable<E>> void heapifyDown(E[] array, int index, int length) {
        ...
        while (index < length / 2) {
            ...
            if(childIndex + 1 < length && isGrater(array, childIndex + 1, childIndex)) {
                childIndex++;
            }

            if(isGrater(array, index, childIndex)) {
                break;
            }
    ...
    private static <E extends Comparable<E>> boolean isGrater(E[] array, int a, int b) {
