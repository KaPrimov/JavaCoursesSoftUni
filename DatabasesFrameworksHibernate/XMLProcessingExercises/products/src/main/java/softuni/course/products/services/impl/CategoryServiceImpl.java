...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public CategoriesStatisticsXmlWrapper findAllByProductsCountXml() {
        List<CategoryStatisticView> categoryStatisticViews = this.findAllByProductsCount();
        CategoriesStatisticsXmlWrapper categoriesStatisticsXmlWrapper = new CategoriesStatisticsXmlWrapper();
        categoriesStatisticsXmlWrapper.setCategoryStatisticViews(categoryStatisticViews);
        return categoriesStatisticsXmlWrapper;
    }
}
